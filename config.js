...
global.github = process.env.GITHUB || "https://github.com/mirichy419/LOGAN-V1";
...
global.scan = "https://logan-V1-xcqv.onrender.com/";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬 MI.RICHY",
  author: process.env.PACK_AUTHER || "*LOGAN V1*",
  packname: process.env.PACK_NAME || "Løgãn V1",
  botname: process.env.BOT_NAME || "LOGAN-V1",
  ownername: process.env.OWNER_NAME || "mį.rįçh¥",
  errorChat: process.env.ERROR_CHAT || "",
  KOYEB_API: process.env.KOYEB_API || "false",
  REMOVE_BG_KEY: process.env.REMOVE_BG_KEY || "neLbXXrp8bSDcohnp1CW5UEa",
  OPENAI_API_KEY: process.env.OPENAI_API_KEY || "sk-proj-pBksWDImP6VuvvJTvqDsT3BlbkFJ2E8GhbpzjyRFkFaBI9Aj",
  HEROKU_API_KEY: process.env.HEROKU_API_KEY || "HRKU-2fc4d785-535b-4113-8291-84c5d3d6d2c3",
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME || "richymd12",
  antilink_values: process.env.ANTILINK_VALUES || "all",
  HEROKU: process.env.HEROKU_APP_NAME && process.env.HEROKU_API_KEY,
  aitts_Voice_Id: process.env.AITTS_ID || "40",
  ELEVENLAB_API_KEY: process.env.ELEVENLAB_API_KEY || "",
  WORKTYPE: process.env.WORKTYPE || process.env.MODE || "private",
  LANG: (process.env.THEME || "LOGAN").toUpperCase(),
};
global.rank = "updated";
